...
public class SuggestionsService {
    ...
    private final IGenericCrudDao<Game> gamesDao;

    public SuggestionsService(ISuggestionService suggestionService, IGenericCrudDao<User> usersDao,
                              IGenericCrudDao<UserPersonalRating> userRatingsDao, IGenericCrudDao<Game> gamesDao) {
